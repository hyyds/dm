...
$.CK_Val = 'Bearer eyJhbGciOiJIUzI1NiJ9.._l6OnBxVDiJ-mqNEO8Mx3o6JFnULJ5iAAvDLTYMNiMc' || $.toObj(getEnv(_key));
...
async function main() {
  intSHA1();
  $.appversion = $.toObj(
    (await $.http.get(`https://itunes.apple.com/cn/lookup?id=1570277888`))?.body
  )?.results[0]?.version;
...
async function getInfo(authorization) {
  const rest = {
    url: "https://api-gw-toc.zeekrlife.com/zeekrlife-mp-mkt/open/v1/activity/get",
    body: JSON.stringify({
      id: "1850807045647036418",
      optional: { fetchMaterial: true, fetchMaterialStore: true },
    }),
    headers: {
      ...gethead(),
      "Eagleeye-Sessionid": "",
  ...
  if (obj.code === "000000") {
    return obj.data.materials[0].id;
  }
}

async function getExchange(authorization,id) {
  const rest = {
    url: "https://api-gw-toc.zeekrlife.com/zeekrlife-mp-mkt/v1/apply/apply",
    body:  JSON.stringify({
      id: "1850807045647036418",
      materialItem: { id },
      payContent: { couponAssetsId: "1995176706933542913" },
    }),
    headers: {
      ...gethead(),
      "Eagleeye-Sessionid": "",
    ...
    var r = function () {
      ...
      a = (o.WordArray = s.extend({
        ...
        concat: function (t) {
          ...
          else for (var a = 0; a < e; a += 4) n[(i + a) >>> 2] = r[a >>> 2];
        ...
        random: function (n) {
            ...
            o = function (n) {
              ...
              return function () {
                var e =
                  ...
                  i;
                return (
                  (e /= 4294967296), (e += 0.5) * (t.random() > 0.5 ? 1 : -1)
                );
              };
            },
            s = !1;
          ...
          for (var c, u = 0; u < n; u += 4)
            s
              ? e.push(r())
              : ((c = 987654071 * (i = o(4294967296 * (c || t.random())))()),
      ...
      u = (c.Hex = {
        stringify: function (t) {
          for (var n = t.words, r = t.sigBytes, i = [], e = 0; e < r; e++) {
      ...
      l = (o.BufferedBlockAlgorithm = s.extend({
        reset: function () {
        ...
        _process: function (n) {
          var r,
            ...
            c = o / (4 * s),
            u =
              (c = n ? t.ceil(c) : t.max((0 | c) - this._minBufferSize, 0)) * s,
            h = t.min(4 * u, o);
          if (u) {
            for (var f = 0; f < u; f += s) this._doProcessBlock(e, f);
            (r = e.splice(0, u)), (i.sigBytes -= h);
          }
    ...
    var t = CryptoJS,
      ...
      s = (e.SHA1 = i.extend({
        ...
        _doFinalize: function () {
          ...
          return (
            (n[i >>> 5] |= 128 << (24 - (i % 32))),
            (n[14 + (((i + 64) >>> 9) << 4)] = Math.floor(r / 4294967296)),
            (n[15 + (((i + 64) >>> 9) << 4)] = r),
